...
select * from midias where ano_lancamento < 1990 order by ano_lancamento;
...
select * from midias where titulo = 'O Rei Leão';


 delete from midias where titulo = 'Titanic';

select * from midias where titulo = 'Titanic';

select * from midias where ano_lancamento = 1985;

delete from midias where ano_lancamento < 1985;

select * from midias where titulo like '%O Senhor dos Anéis%' or titulo like 'Toy%';
