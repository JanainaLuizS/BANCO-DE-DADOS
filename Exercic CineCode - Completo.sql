...
select * from clientes where regiao like 'Sudeste' and sexo = 'feminino';
...
select * from clientes order by data_conta asc limit 10;
...
select * from filmes where titulo like 'Rio 2';
...
where genero like 'Comedia' and ano_lancamento = 2001;

select * from filmes where genero like 'Comedia';
...
-- Qual é o erro? _____________ausência do sinal >_____________________________________________
-- Correção:
...
-- Qual é o erro? ____________ausência da palavra região______________________________________________
-- Correção:
...
-- Qual é o erro? _____________uso incorreto do sinal , deve- se usar IS ____________________________________________
-- Correção:
SELECT * FROM alugueis WHERE nota is NULL; # se quisesse o que não tá nulo escreveria: is not null
...
-- Qual é o erro? ___________nome incorreto da tabela_______________________________________________
-- Correção:
...
-- Qual é o erro? ____________ausência da palavra  where______________________________________________
-- Correção 
...
select avg (nota) as media from alugueis where nota is not null;

# se quiser arredondar usa : round e a quantidade de casas q quer arredondar

select round(avg(nota),2)as media from alugueis where nota is not null;
